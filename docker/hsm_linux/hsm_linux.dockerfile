...
COPY aws_iot_core_credential_provider_session_helper-0.0.0-py3-none-any.whl .
RUN pip3.11 install --upgrade pip \
    && pip3.11 install aws_iot_core_credential_provider_session_helper-0.0.0-py3-none-any.whl
    # Run the application:
